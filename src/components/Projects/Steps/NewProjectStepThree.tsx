...
const NewProjectStepThree = (props: any) => {
    ...
    const { projectData: {stepThree}, projectData, setProjectData } = props;
            ...
            <div className={classes.middleView}>
                ...
                <div style={{ height: '120px', overflowY: 'scroll', marginTop: 5, paddingTop: 5, paddingBottom: 10 }}>
                    {stepThree.expenses && stepThree.expenses.length > 0 ? 
                        stepThree.expenses.map((data: StretegyExpenses, index: number) => {
    ...
    const renderBackButton = () => {
        return (
            <IconButton aria-label="back" className={classes.backButton} onClick={() => props.setCurrentStep(2)}>
        ...
        return (
            <div className={classes.bottomView}>
                    <Typography variant={'caption'} className={classes.bottomLeftView}>
                        *This will be added to the final invoice sent to client. The campaign budget will be the total amount due
                        to the client. You can go back and edit this page again if needed.
                    </Typography>
