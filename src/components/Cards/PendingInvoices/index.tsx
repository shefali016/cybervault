    ...
    const classes = useStyles();
      return  (<Card className={classes.card}>
            <CardContent>
                ...
                <LinearProgress className={classes.progressBar} variant="determinate" value={props.unpaidAmount ? props.unpaidAmount : 50}  />
                <h6 className={classes.BodyText}> $ {props.paidAmount ? props.paidAmount : 0}  Paid</h6>
                <LinearProgress className={classes.progressBar} variant="determinate" value={props.paidAmount ? props.paidAmount : 50}/>
            </CardContent>
        </Card>);
}
