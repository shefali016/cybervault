import {
  ...
  const authReducer = (state = initialState, action: Action) => {
    switch (action.type) {
      ...
      case GET_ALL_PROJECT_REQUEST: return getAllProjects(state, action)
      case GET_ALL_PROJECT_SUCCESS: return getAllProjectsSuccess(state, action)
      case GET_ALL_PROJECT_FAILURE: return getAllProjectsFailure(state, action)
